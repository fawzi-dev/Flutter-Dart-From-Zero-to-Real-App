...
- A large styled `ROLL` button with an icon, centered below the dice — **disabled for now** (`onPressed: null`), because nothing can happen yet
...
4. The button: your own `TextStyle`, generous padding — make it look pressable.
